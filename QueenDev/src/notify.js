...
(function ($) {
    ...
    /**
     * Envía una notificación predeterminada. El tipo de notificación se puede pasar como opción.
    * */
    ...
    /**
     * Borra todas las notificaciones activas con el retraso de desaparición especificado.
     * @param {any} fadeOutDelay Tiempo de transición de desvanecimiento en milisegundos.
     */

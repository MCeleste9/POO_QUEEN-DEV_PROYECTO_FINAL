...
// Subir datos de archivos a Firebase
...
//Borrar datos de archivos a Firebase
function deleteFile($){
...
// Pase el nombre de la casilla de verificación a la función
function getCheckedBoxes(chkboxName) {
    var checkboxes = document.getElementsByName(chkboxName);
    var checkboxesChecked = [];
    // Bucle sobre todas ellas
    for (var i=0; i<checkboxes.length; i++) {
       // Y pegue los marcados en una matriz
       if (checkboxes[i].checked) {
          checkboxesChecked.push(checkboxes[i]);
       }
    }
    // Devuelve la matriz si no está vacía o es nula
